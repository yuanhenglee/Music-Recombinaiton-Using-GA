...
def startGA(initialAncestors, population, mutation_rate=0.25, crossover_rate=0.3, max_generation=1000, max_population=1000, n_generation_terminate=100, generation_to_kill=10):
